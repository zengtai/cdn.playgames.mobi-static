...
const topGames = getGames(topGamesData, `list`);
const featuredGames = getGames(featuredGamesData, `list`);
...
banner.forEach((i) => {
  ...
  script.textContent = `(adsbygoogle = window.adsbygoogle || []).push({}); console.log("Hi")`;
